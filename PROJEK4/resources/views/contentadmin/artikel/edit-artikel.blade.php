 ...
 <div class="modal fade" id="modalEditArt{{ $art->id }}" tabindex="-1" role="dialog"
     ...
     <div class="modal-dialog modal-lg" role="document">
         <div class="modal-content">
             ...
             {{-- FORM INPUT --}}
             <form action="{{ route('artikelUpdate', $art->id) }}" method="POST" enctype="multipart/form-data">
                 @csrf
                 <div class="modal-body">
                     ...
                     <div class="form-group">
                         ...
                         <select class="form-control" id="id_kategori" name="id_kategori">
                             <option value="{{ $art->katFK->id }}">{{ $art->katFK->nama_kategori }}</option>
                     ...
                     <div class="form-group">
                         ...
                         <trix-editor input="deskripsi">{{ $art->deskripsi }}</trix-editor>
                     </div>
